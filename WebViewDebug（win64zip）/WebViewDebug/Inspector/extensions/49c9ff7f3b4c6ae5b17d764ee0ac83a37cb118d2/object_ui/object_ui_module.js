...
return;this._editableDiv=this.listItemElement.createChild('span','editable-div');var text=this.property.value.description;if(this.property.value.type==='string'&&typeof text==='string')
